...
- O corpo tem seis figuras e cinco tabelas principais (Tabela 5, comparação confirmatória do ensemble, acrescentada na Rodada 12); os apêndices contêm as Tabelas A1 a A3, e o material suplementar vai até S17 (S17 é provisória, ver Rodada 11 em `PLANO_ARTIGO_CAPITULO.md`).
