...
- A lista de referências tem 44 entradas, todas citadas no corpo, sem duplicatas nem citação órfã (a entrada órfã de BRASIL, 2018, saiu na Rodada 12, junto com a prosa que a citava).
- A avaliação temporal não foi executada por ausência de data no corpus, e a limitação está declarada na Subseção 5.3.
- PDF regenerado pelo workflow oficial na Rodada 12; página e resultado da inspeção visual registrados em `verificacao/relatorio_revisao_v4.md`.
