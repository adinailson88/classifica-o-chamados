...
- **Pendência registrada na Rodada 9, fora do escopo tipográfico:** o eixo Y da Figura 2 (trade-off de custo) arredonda os rótulos para uma casa decimal, fazendo marcas distintas (~0,80/0,82/0,85) aparecerem como "0,8" repetido; a correção exige editar `src/gerar_figura3_tradeoff_custo.py` e regenerar o artefato da figura, não apenas o LaTeX do artigo.
