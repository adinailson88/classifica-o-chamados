...
- **Rodada 13 concluída**: correção bibliográfica conforme NBR 6023:2025/NBR 10520:2023 — chamadas autor-data convertidas de caixa alta para Maiúscula/minúscula, ordem de autoria de Marcuzzo *et al.* corrigida, referência de Brown *et al.* simplificada, destaque tipográfico padronizado nas 44 referências, DOIs verificados em fonte primária (23 inseridos, 3 reformatados, 1 completado com URL/acesso, 10 confirmados sem DOI), correções pontuais de metadados, e remoção do percentual "menos de 2%" não comprovado na Introdução. Zero retreino: fits de modelo-base = 0, fits de stacking = 0, execuções LSTM = 0. Detalhes completos em `docs/AUDITORIA_REFERENCIAS_2025.md`.
